...
files = list.files(path = "data/raw/exp1_motion", pattern = 'special')
files=paste0("data/raw/exp1_motion/",files)
...
session = read.table(file="data/raw/exp1_motion/rdm-study6ap-20180704091936.csv",header=T,sep=",") %>%
...
#save imported data
save(imported_data,file="data/clean/imported_data_exp1.RData")
...
save(trimmed_data,file="data/clean/trimmed_data_exp1.RData")
