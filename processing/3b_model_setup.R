...
p.map=list(A="1",B=c("Emph"),mean_v=c("Cont","Emph","M"),sd_v="1",t0="1",st0="1")
...
save(starting_samples,file=paste0("../model_output/starting_values_exp2_",source_,"_",wave_,".RData"))
