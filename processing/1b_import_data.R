...
session = read.table(file="../raw_data/exp2_brightness/bright-study6bp-20180704092600.csv",header=T,sep=",") %>% 
...
#save imported data
save(imported_data,file="../clean_data/imported_data_exp2.RData")
...
save(trimmed_data,file="../clean_data/trimmed_data_exp2.RData")
